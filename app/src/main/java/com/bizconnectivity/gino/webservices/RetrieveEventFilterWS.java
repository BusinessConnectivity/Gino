...
public class RetrieveEventFilterWS {
    ...
    public static List<Event> invokeRetrieveNearbyEventFilter(String latitude, String longitutde, String kilometer,
        ...
        //property which holds input parameters
        PropertyInfo longitutdePI = new PropertyInfo();
        //set name
        longitutdePI.setName("longitude");
        //set value
        longitutdePI.setValue(longitutde);
        //set datatype
        longitutdePI.setType(String.class);
        //add the property to request object
        request.addProperty(longitutdePI);
